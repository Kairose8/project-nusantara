  ...
  return (
    <>
      <div className="h-screen flex flex-col items-center text-center ">
        <p class="font-serif text-5xl mb-10 mt-52 text-white w-2/3 lg:w-max">
          The Amazing Yogyakarta
        </p>
        <p class="font-grotesk text-white text-justify  md:text-sm w-2/3 lg:text-xl lg:w-3/5">
        ...
        <br />
        <p class="font-grotesk text-white w-1/3">
