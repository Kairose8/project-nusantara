          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-80 md:w-96 mb-5 p-6 bg-myColor-500 border border-myColor-600 rounded-lg">
              ...
              <p className="mb-3 text-xs text-stone-300 ">
                Also known as Indonesian is the country's national language, it
                would really help to know a few phrases.
              </p>
              <a
            ...
            <div className="w-80 md:w-96 mb-5 p-6 bg-myColor-500 border border-myColor-600 rounded-lg">
              ...
              <p className="mb-3 text-xs text-stone-300 ">
                known commonly as Javanese, is the language of the natives that
                reside in Yogyakarta.
              </p>
              <a
