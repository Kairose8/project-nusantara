      ...
      <div className="h-screen">
        ...
        <div>
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <div className="w-4/5 left-14 font-sans text-lg text-white md:w-1/3 ">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-80 md:w-96 mb-5 p-6 bg-myColor-500 border border-myColor-600 rounded-lg">
              ...
              Also known as Indonesian is the country's national language, it would really help to know a few phrases.
              </p>
              <a
                ...
                className="inline-flex font-medium items-center text-blue-950
              hover:underline"
              >
                Learn Indonesian
            ...
            <div className="w-80 md:w-96 mb-5 p-6 bg-myColor-500 border border-myColor-600 rounded-lg">
              ...
              <p className="mb-3 text-xs text-stone-300 ">
              known commonly as Javanese, is the language of the natives that reside in Yogyakarta.
              </p>
              <a
