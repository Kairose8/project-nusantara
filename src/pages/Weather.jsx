    ...
    <div className="xsm:h-screen">
      <div className="container mx-auto pt-20">
        ...
        <div className="text-center mb-8">
          ...
          {forecastData && (
            <h2 className="text-2xl md:text-4xl text-stone-300">
        ...
        {!loading && forecastData && (
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl mb-2 text-stone-300">
            ...
            <div className="w-full md:w-5/6 overflow-x-auto">
              <div className="flex">
                {forecastData.list
                  ...
                  .map((forecast, index) => (
                    <div
                      className="w-1/3 p-4 mx-2 bg-white bg-opacity-50 rounded-lg text-center"
                      key={index}
                    >
